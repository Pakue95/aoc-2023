...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `133.4µs` | `963.3µs` |
| [Day 2](./src/bin/02.rs) | `92.0µs` | `91.3µs` |
| [Day 3](./src/bin/03.rs) | `1.2ms` | `1.3ms` |
| [Day 4](./src/bin/04.rs) | `101.2µs` | `104.1µs` |
| [Day 5](./src/bin/05.rs) | `47.4µs` | `151.0µs` |
| [Day 6](./src/bin/06.rs) | `519.0ns` | `491.0ns` |
| [Day 7](./src/bin/07.rs) | `451.9µs` | `484.4µs` |
| [Day 8](./src/bin/08.rs) | `403.3µs` | `5.1ms` |
| [Day 9](./src/bin/09.rs) | `289.6µs` | `277.0µs` |
